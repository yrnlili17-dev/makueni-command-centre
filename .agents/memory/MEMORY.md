...
- [Two poll systems](two-poll-systems.md) — commandcentre `opinion_polls` ("Makueni polls") and insights `insight_polls` are separate and don't sync; how to bridge them.
