...
const DEMOGRAPHIC_TYPES = [
  ...
  { key: "market_traders",   label: "MARKET TRADERS",     icon: "ShoppingBag",  description: "Wote, Makindu and Emali markets",      color: "#FB923C" },
] as const;
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-base font-bold tracking-widest">CAMPAIGN SEGMENT INTELLIGENCE</h1>
          <p className="text-[9px] font-mono text-muted-foreground mt-1 tracking-widest">PROF. PHILIP KALOKI 2027 · MAKUENI COUNTY TARGETING ENGINE</p>
        </div>
        <button
