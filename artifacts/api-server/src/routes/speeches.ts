...
Make commitments concrete and grounded in Makueni Constituency realities.`;
  ...
  sectionCalls.push(
    generateSection(
      base,
      `Write the PREAMBLE / VISION (~180 words): who Prof. Philip Kaloki is, his covenant with the people of Makueni, and the vision for the constituency toward the August 2027 election.${issuesLine}`,
      520,
