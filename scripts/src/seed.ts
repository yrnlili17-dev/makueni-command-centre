...
async function seedMembers() {
  ...
  for (let i = 0; i < 120; i++) {
    ...
    members.push({
      ...
      email: Math.random() > 0.5 ? `voter${i + 1}@matungulu.ke` : null,
      phone: phone(),
      ward,
...
async function seedSegments() {
  ...
  const segs = [
    ...
    {
      name: "Undecided — Tala & Matungulu East",
    ...
    {
      name: "SMS Consented — Matungulu North",
      description: "Bulk SMS broadcast list for Matungulu North",
      criteria: { ward: "Matungulu North", smsConsent: true },
      memberCount: 22,
      isLocked: false,
    },
    {
...
async function seedMessaging(segments: any[]) {
  ...
  const campaigns = [
    ...
    {
      name: "Matungulu Development Manifesto — WhatsApp",
      channel: "whatsapp",
      status: "sent",
    ...
    },
    {
      ...
      channel: "email",
      status: "sent",
      messageBody: "Dear Supporter, Thank you for your continued support for Hon. Stephen Mule. As we approach 2027, our development agenda for Matungulu is clear...",
      segmentId: null,
      recipientCount: 48,
      deliveredCount: 45,
      openedCount: 31,
    ...
    },
    {
      ...
      channel: "whatsapp",
      status: "scheduled",
      messageBody: "Stephen Mule amewaletea barabara ya Tala–Matungulu. Miradi mingine inakuja 2027. Jiunge nasi leo.",
      segmentId: segments[1]!.id,
      recipientCount: 14,
      deliveredCount: 0,
      openedCount: 0,
...
async function seedVolunteers() {
  ...
  const vols = [
    ...
    { firstName: "Bernard", lastName: "Mwangi", ward: "Matungulu North", role: "team_lead", doorsKnocked: 98, hoursLogged: 24 },
    { firstName: "Lucy", lastName: "Ndunda", ward: "Matungulu West", role: "canvasser", doorsKnocked: 76, hoursLogged: 18 },
    { firstName: "Edwin", lastName: "Kioko", ward: "Matungulu East", role: "canvasser", doorsKnocked: 63, hoursLogged: 15 },
    { firstName: "Veronica", lastName: "Musyoka", ward: "Kyeleni", role: "team_lead", doorsKnocked: 87, hoursLogged: 22 },
    { firstName: "Collins", lastName: "Muema", ward: "Matungulu East", role: "canvasser", doorsKnocked: 54, hoursLogged: 13 },
    { firstName: "Sylvia", lastName: "Wambua", ward: "Tala", role: "phone_banker", doorsKnocked: 0, hoursLogged: 31 },
    { firstName: "Jackson", lastName: "Mutiso", ward: "Matungulu North", role: "canvasser", doorsKnocked: 89, hoursLogged: 20 },
    { firstName: "Peninah", lastName: "Kimeu", ward: "Kyeleni", role: "canvasser", doorsKnocked: 47, hoursLogged: 11 },
    { firstName: "Victor", lastName: "Mwenda", ward: "Matungulu East", role: "canvasser", doorsKnocked: 71, hoursLogged: 17 },
    { firstName: "Lorna", lastName: "Munyao", ward: "Matungulu West", role: "data_entry", doorsKnocked: 0, hoursLogged: 26 },
    { firstName: "Felix", lastName: "Ndeti", ward: "Matungulu East", role: "canvasser", doorsKnocked: 58, hoursLogged: 14 },
    { firstName: "Gloria", lastName: "Maluki", ward: "Tala", role: "canvasser", doorsKnocked: 83, hoursLogged: 19 },
    { firstName: "Henry", lastName: "Nzioka", ward: "Matungulu North", role: "team_lead", doorsKnocked: 112, hoursLogged: 29 },
...
async function seedFieldOps(volunteers: any[]) {
  ...
  const sessions = [
    ...
    { name: "Matungulu North Door Knock", ward: "Matungulu North", date: daysAgo(22).toISOString().slice(0,10), status: "completed", doorsTarget: 60, doorsCompleted: 58, assignedVolunteers: 3 },
    ...
    { name: "Matungulu East Saturday Drive", ward: "Matungulu East", date: daysAgo(8).toISOString().slice(0,10), status: "completed", doorsTarget: 70, doorsCompleted: 61, assignedVolunteers: 3 },
    { name: "Matungulu West Outreach", ward: "Matungulu West", date: daysAgo(3).toISOString().slice(0,10), status: "completed", doorsTarget: 55, doorsCompleted: 49, assignedVolunteers: 2 },
    { name: "Matungulu East Phase 2", ward: "Matungulu East", date: daysAgo(1).toISOString().slice(0,10), status: "active", doorsTarget: 65, doorsCompleted: 31, assignedVolunteers: 2 },
  ...
  const outcomesByWard: Record<string, [string, number][]> = {
    ...
    "Matungulu North": [["support",28],["strong_supporter",10],["undecided",14],["oppose",4],["not_home",2]],
    "Kyeleni":         [["support",18],["strong_supporter",6],["undecided",12],["oppose",5],["not_home",2]],
    "Matungulu East":  [["support",24],["strong_supporter",9],["undecided",16],["oppose",8],["not_home",4]],
    "Matungulu West":  [["support",22],["strong_supporter",8],["undecided",11],["oppose",6],["not_home",2]],
  };

  const streets: Record<string, string[]> = {
    "Tala":            ["Tala–Matuu Rd","Market St","Church Lane","Cooperative Ave","Kibauni Rd"],
    "Matungulu North": ["Kangundo Rd","Katangi Rd","Kyumbi Lane","Ndalani Rd","Chief's Rd"],
    "Kyeleni":         ["Kyeleni–Tala Rd","Stoneham St","Mwea Rd","Irrigation Way","Mission Rd"],
    "Matungulu West":  ["Athi River Rd","Mwala–Matungulu Rd","Junction St","Githua Rd","Valley Rd"],
    "Matungulu East":  ["Masinga Rd","Yatta Rd","Thika–Garissa Hwy","Kyatune Lane","School Rd"],
  };
...
async function seedSurveys() {
  ...
  const [survey] = await db.insert(surveysTable).values({
    title: "Matungulu 2027 Voter Priorities Survey",
    description: "Understanding what issues matter most to Matungulu residents",
    status: "active",
    questions: [
      { id: "q1", text: "What is the most important issue in Matungulu?", type: "single_choice", options: ["Roads & Infrastructure", "Water Access", "Youth Employment", "Education", "Healthcare", "Security"], order: 1 },
  ...
  const answers = [
    ...
    [{ q1: "Roads & Infrastructure", q2: "4", q3: "Definitely Yes", q4: "Matungulu East feeder roads remain murram" }],
...
async function seedEvents() {
  ...
  const events = [
    { title: "Tala Ward Rally", type: "rally", location: "Tala Social Hall", ward: "Tala", startDate: daysAgo(20).toISOString().slice(0,10), status: "completed", attendeeCount: 312, maxAttendees: 400, description: "Main launch rally for Matungulu 2027 campaign" },
    { title: "Matungulu North Townhall", type: "townhall", location: "Kyumbi Primary School Grounds", ward: "Matungulu North", startDate: daysAgo(12).toISOString().slice(0,10), status: "completed", attendeeCount: 184, maxAttendees: 250, description: "Community Q&A session with Hon. Mule" },
    ...
    { title: "Youth Jobs Fair — Matungulu East", type: "community", location: "Yatta Junction Market Square", ward: "Matungulu East", startDate: daysAgo(2).toISOString().slice(0,10), status: "completed", attendeeCount: 228, maxAttendees: 300, description: "Youth employment linkage event with Machakos County" },
    ...
    { title: "Matungulu West Townhall", type: "townhall", location: "Matungulu West Chief's Camp", ward: "Matungulu West", startDate: daysFromNow(9), status: "scheduled", attendeeCount: 0, maxAttendees: 200, description: "Community forum — roads and water agenda" },
    ...
    { title: "Fundraising Dinner — Nairobi Diaspora", type: "fundraiser", location: "Sarova Panafric Hotel, Nairobi", ward: null, startDate: daysFromNow(25), status: "scheduled", attendeeCount: 0, maxAttendees: 120, description: "Campaign fundraiser targeting Matungulu diaspora in Nairobi" },
    { title: "Matungulu East Ward Drive", type: "canvass", location: "Yatta Junction", ward: "Matungulu East", startDate: daysFromNow(11), status: "scheduled", attendeeCount: 0, maxAttendees: 0, description: "Coordinated door-to-door sweep of Matungulu East" },
  ];
...
async function seedIntelligence() {
  ...
  await db.insert(narrativeMentionsTable).values([
    { platform: "Facebook", content: "Mule amejaza mifuko yake tu! Hajafanya kitu Matungulu kwa miaka 5. Acheni uwongo!", author: "MatunguluMtaa", threatLevel: "high", status: "responded", counterNarrative: "Hon. Mule amewaletea Matungulu miradi ya maji ya Kyeleni, bursaries 847, na ujenzi wa barabara ya Tala–Matuu. Tunaendelea.", detectedAt: daysAgo(18), respondedAt: daysAgo(17) },
    { platform: "Twitter/X", content: "Why is Tala–Matuu road still unpaved after 5 years? Mule keep promising, zero delivery. #MatunguluDeservesBetter", author: "@TalaActivist", threatLevel: "medium", status: "responded", counterNarrative: "Phase 1 of Tala–Matuu road (8km) completed 2024. Phase 2 funded by NG-CDF. Works commence Q3 2026.", detectedAt: daysAgo(11), respondedAt: daysAgo(10) },
    ...
    { platform: "Facebook", content: "BREAKING: Voter bribery allegations surface in Matungulu East — unnamed MP accused of vote buying scheme", author: "MatunguluNews254", threatLevel: "critical", status: "open", counterNarrative: null, detectedAt: daysAgo(2) },
    { platform: "TikTok", content: "Ndani ya gari ya Mule — hizo zimekuwa bei gani? Wananchi wanaomba uji, yeye ana Range Rover mbili", author: "@MatunguluVlogger", threatLevel: "medium", status: "monitoring", counterNarrative: null, detectedAt: daysAgo(6) },
  ...
  await db.insert(competitorsTable).values([
    {
      ...
      strengths: ["National government backing", "Control of county resources", "Strong youth following in Matungulu East", "Well-funded war chest"],
      weaknesses: ["Weak ground presence in Kyeleni", "No track record on water projects", "Viewed as outsider to Matungulu North", "Recent land scandal allegations"],
    ...
    },
    {
      ...
      party: "Independent",
      constituency: "Matungulu",
      strengths: ["Popular businessman in Tala", "Self-financed campaign", "Known in Matungulu West"],
  ...
  await db.insert(warRoomBriefsTable).values([
    { title: "CRITICAL: Vote Buying Allegations — Matungulu East", summary: "Social media and local informants report opposition distributing cash in Matungulu East ward. Targeting undecided voters aged 18–35. Network of 6 brokers identified.", priority: "urgent", category: "NARRATIVE", actions: ["Deploy rapid response team to Matungulu East immediately", "Document evidence — photograph + video", "Issue press statement by COB today", "Alert IEBC field officers"], status: "active" },
    { title: "Malombe Ground Team Gaining in Matungulu East", summary: "Opposition coordinator Bernard Muli running parallel voter registration exercise in Matungulu East. Handing out branded merchandise. Estimate 200+ new registrations in 3 weeks.", priority: "high", category: "FIELD INTEL", actions: ["Accelerate Matungulu East canvass sessions", "Counter with bursary distribution event", "Deploy 2 additional volunteers to Matungulu East"], status: "active" },
...
async function seedCampaignPlan() {
  ...
  await db.insert(milestonesTable).values([
    ...
    { title: "Ward Launch Rallies (Tala + North)", category: "Events", dueDate: "2026-04-30", status: "completed", owner: "Events Team", description: "Rallies completed in Tala and Matungulu North" },
...
async function seedKOL() {
  ...
  await db.insert(kolTable).values([
    ...
    { name: "Mama Grace Ndunda", platform: "WhatsApp", handle: null, tier: "micro", influenceScore: 62, followerCount: 800, alignment: "supporter", ward: "Matungulu North", notes: "Chairs women's group network across North ward. Key mobiliser." },
    { name: "Bw. Kamau Mwangangi", platform: "Facebook", handle: "KamauMwangangi254", tier: "mid", influenceScore: 71, followerCount: 9800, alignment: "neutral", ward: "Matungulu East", notes: "Respected teacher and blogger. Neutral — needs cultivation." },
    ...
    { name: "Fr. Benedict Kioko", platform: "Facebook", handle: "FrBenedictKioko", tier: "mid", influenceScore: 68, followerCount: 7100, alignment: "supporter", ward: "Matungulu East", notes: "Catholic priest. Spoken positively of Mule's bursary programme." },
    { name: "Matungulu Business Forum", platform: "Facebook", handle: "MatunguluBizForum", tier: "macro", influenceScore: 83, followerCount: 21000, alignment: "neutral", ward: null, notes: "Business association covering all 5 wards. Key endorsement target." },
    { name: "Teacher Waweru Mwangi", platform: "Twitter/X", handle: "@WaweruMatungulu", tier: "micro", influenceScore: 47, followerCount: 2100, alignment: "opponent", ward: "Matungulu West", notes: "Critical of NG-CDF allocation. Active online — monitor closely." },
    ...
    { name: "Daktari James Muema", platform: "Facebook", handle: "DrMuemaMatungulu", tier: "mid", influenceScore: 64, followerCount: 5400, alignment: "supporter", ward: "Kyeleni", notes: "Clinic owner. Champions healthcare agenda. Publicly backed Mule." },
  ]);
...
async function seedFundraising() {
  ...
  const campaigns = await db.insert(fundraisingCampaignsTable).values([
    { name: "Nairobi Diaspora Dinner", description: "Fundraising dinner targeting Matungulu diaspora in Nairobi", goalAmount: 2000000, raisedAmount: 0, status: "active", startDate: "2026-06-01", endDate: "2026-08-31" },
    ...
    { name: "Business Community Levy", description: "Contributions from Tala and Matungulu business community", goalAmount: 3000000, raisedAmount: 0, status: "active", startDate: "2026-04-01", endDate: "2027-06-30" },
  ...
  const donationRows = [
    ...
    { campaignId: campaigns[1]!.id, donorName: "Bernard Mwangi", amount: 3000, channel: "cash", ward: "Matungulu North", reference: null, notes: null },
    { campaignId: campaigns[1]!.id, donorName: "Lucy Ndunda", amount: 2000, channel: "mpesa", ward: "Matungulu West", reference: "MP8X3TQ9LP", notes: null },
    { campaignId: campaigns[1]!.id, donorName: "Edwin Kioko", amount: 5000, channel: "cash", ward: "Matungulu East", reference: null, notes: null },
    ...
    { campaignId: campaigns[1]!.id, donorName: "Collins Muema", amount: 2500, channel: "cash", ward: "Matungulu East", reference: null, notes: null },
    { campaignId: campaigns[1]!.id, donorName: "Mama Grace Ndunda", amount: 10000, channel: "mpesa", ward: "Matungulu North", reference: "GN8TX3QR2P", notes: "Women's group collection" },
    ...
    { campaignId: campaigns[2]!.id, donorName: "Matungulu Farmers Coop", amount: 150000, channel: "bank", ward: "Matungulu West", reference: "TXN20260501002", notes: "Cooperative annual pledge" },
    ...
    { campaignId: campaigns[2]!.id, donorName: "Matungulu Quarry Owners", amount: 200000, channel: "bank", ward: "Matungulu East", reference: "TXN20260510001", notes: "Annual contribution from quarry consortium" },
    ...
    { campaignId: campaigns[4]!.id, donorName: "Matungulu Business Forum", amount: 150000, channel: "bank", ward: null, reference: "TXN20251115001", notes: "Forum inaugural contribution" },
  ];
  ...
  const donors = await db.insert(donorsTable).values([
    ...
    { name: "Matungulu Farmers Coop", phone: "0700-200-200", email: "coop@matungulufarmers.co.ke", ward: "Matungulu West", type: "organization", tier: "major", totalGiven: 150000, notes: "Cooperative annual pledge agreement", tags: "coop, farmers, matungulu-west" },
    { name: "Matungulu Quarry Owners", phone: "0700-300-300", email: null, ward: "Matungulu East", type: "organization", tier: "major", totalGiven: 200000, notes: "Annual contribution from quarry consortium", tags: "quarry, consortium, matungulu-east" },
    ...
    { name: "Mama Esther Mwangi", phone: "0713-006-006", email: null, ward: "Matungulu North", type: "individual", tier: "regular", totalGiven: 50000, notes: "Community leader, women's group chair", tags: "women-leader, matungulu-north" },
    ...
    { name: "Matungulu Business Forum", phone: "0700-600-600", email: null, ward: null, type: "organization", tier: "regular", totalGiven: 150000, notes: "Forum inaugural contribution", tags: "business-forum, inaugural" },
    ...
    { name: "Bernard Mwangi", phone: "0713-008-008", email: null, ward: "Matungulu North", type: "individual", tier: "grassroots", totalGiven: 3000, notes: null, tags: "grassroots" },
    { name: "Lucy Ndunda", phone: "0714-009-009", email: null, ward: "Matungulu West", type: "individual", tier: "grassroots", totalGiven: 2000, notes: null, tags: "grassroots" },
    { name: "Edwin Kioko", phone: "0715-010-010", email: null, ward: "Matungulu East", type: "individual", tier: "grassroots", totalGiven: 5000, notes: null, tags: "grassroots" },
  ...
  await db.insert(pledgesTable).values([
    ...
    { donorName: "Matungulu Farmers Coop", donorId: donors[4]!.id, campaignId: campaigns[2]!.id, amount: 200000, promisedDate: "2026-09-01", status: "pending", channel: "bank", notes: "Second annual cooperative pledge" },
    ...
    { donorName: "Matungulu Quarry Owners", donorId: donors[5]!.id, campaignId: campaigns[2]!.id, amount: 300000, promisedDate: "2026-10-01", status: "pending", channel: "bank", notes: "Quarry consortium Q3 pledge" },
    ...
    { donorName: "Matungulu Business Forum", donorId: donors[14]!.id, campaignId: campaigns[2]!.id, amount: 250000, promisedDate: "2026-06-30", status: "defaulted", channel: "bank", notes: "Forum failed to deliver — follow up required" },
  ]);
...
async function seedElectionDay() {
  ...
  const stationsByWard: Record<string, { code: string; name: string; voters: number; streams: number; agent: string; phone: string }[]> = {
    ...
    "Matungulu North": [
      { code: "MTN-001", name: "Matungulu North Primary", voters: 690, streams: 2, agent: "David Kioko", phone: "0712-345-010" },
    ...
    "Matungulu West": [
      { code: "MTW-001", name: "Matungulu West Primary", voters: 770, streams: 2, agent: "Paul Malonza", phone: "0712-345-020" },
    ...
    "Matungulu East": [
      { code: "MTE-001", name: "Matungulu East Primary", voters: 760, streams: 2, agent: "Thomas Muli", phone: "0712-345-030" },
  ...
  await db.insert(electionEventsTable).values([
    { type: "milestone", title: "Polling Stations Open", description: "All 20 polling stations in Matungulu opened on time at 06:00 hrs", ward: null, stationCode: null, priority: "normal", status: "resolved" },
    ...
    { type: "alert", title: "Ballot Shortage MTN-002", description: "Muumandu Primary School reported 40 extra ballots needed — supply dispatched", ward: "Matungulu North", stationCode: "MTN-002", priority: "high", status: "resolved" },
    { type: "incident", title: "Minor Scuffle at MTW-003", description: "Brief altercation outside Kyamumbi Community Hall — police intervened, polling resumed normally", ward: "Matungulu West", stationCode: "MTW-003", priority: "high", status: "resolved" },
    ...
    { type: "info", title: "Counting Ongoing — 5 Wards", description: "All stations in Tala, Matungulu North processing results. 4 verified so far.", ward: null, stationCode: null, priority: "normal", status: "open" },
